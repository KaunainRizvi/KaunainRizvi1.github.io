...
const phrases = [
  ...
  "you can stop now.",
  "so you like my portfolio website? 🥳",
  "seriously!🤩",
  ...
  return (
    <section className="w-full cursor-default bg-[#420fe7] xl:px-44 lg:px-40 sm:pt-48 sm:pb-0 pt-28 md:px-32 sm:px-28 vvs:px-12 px-10">
      <div className="hero-container flex flex-col">
        ...
        >
          <div className="flex items-center"> {/* Wrap the image and phrases in a flex container */}
  <div>
    <Tooltip
      title={phrases[index]}
    ...
    >
      <img
        ...
        id="profilePhoto"
        className="rounded-full !z-10 hover:scale-[1.05] hover:shadow-custom1 hover:-rotate-12 transition-all duration-300 ease-in-out cursor-pointer"
        style={{ width: '30%' }}
      />
    </Tooltip>
  </div>
...
<div className="flex items-center">
  ...
  <a
    href="https://drive.google.com/file/d/1udpDMd2FHSbmMBLtchIzmuOgPeLCrx10/view?usp=drive_link"  
